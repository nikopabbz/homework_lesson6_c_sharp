...
System.Console.WriteLine();
System.Console.WriteLine($"Разность между суммой максимальных значений по каждой строке и суммой минимальных значений по каждому столбцу = {SumMaxLines(array)-SumMinColumns(array)}");